...
OBJS ?= $(SRC_DIR)/main.cpp $(SRC_DIR)/ui_system.cpp $(SRC_DIR)/leaderboard.cpp $(SRC_DIR)/screens.cpp $(SRC_DIR)/player.cpp $(SRC_DIR)/tiles.cpp $(SRC_DIR)/pickup.cpp $(SRC_DIR)/graph.cpp
