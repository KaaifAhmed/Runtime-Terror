...
public:
    enum class Style {
        TERMINAL_ERROR,      // Black screen, red text, command line style
        WINDOWS_BSOD,        // Classic blue screen
        COMPILER_ERROR,      // VS Code terminal error style
        SYNTAX_ERROR         // Code syntax error display
    };
