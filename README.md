...
## How to run
If you want to modify the code, or work on the game:
- Download and install Raylib from https://raysan5.itch.io/
- Run the "main.code-workspace" file to open in VS Code
- Run the "main.cpp" file from src folder